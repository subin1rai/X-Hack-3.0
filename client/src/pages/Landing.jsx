  ...
  <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-md">
    <form>
      ...
      <div className="text-center">
        <button
          type="submit"
          className="px-6 py-3 bg-green-600 text-white text-lg font-semibold rounded-lg shadow-md hover:bg-green-700 transition-all focus:outline-none focus:ring-2 focus:ring-green-500"
        >
          Send Message
        </button>
      </div>
